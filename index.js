...
const modalMessageList = [
  ...
  { "number": 25, "message": "행복의 계절, 모두가 함께하는 24일!" },
  { "number": 26, "message": "이 12월, 행복한 순간이 우리를 감싸네요." },
  { "number": 27, "message": "다 같이 즐겁게 보내는 24일, 행복이 가득합니다!" },
  { "number": 28, "message": "12월의 특별함을 모두와 함께 나누어요." },
  { "number": 29, "message": "각자의 작은 행복이 모여 만드는 특별한 24일!" },
  { "number": 30, "message": "행복이라는 이름의 캘린더, 모두에게 열려 있어요." },
  { "number": 31, "message": "함께 하는 즐거움, 24일 동안 계속되길 바랍니다." }
];
